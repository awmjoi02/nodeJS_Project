...
router.get('/', verifyToken, async(req, res) => {
    try {
        const posts = await Post.find({ user: req.userId }).populate('user', ['username']) //populate('user', ['username']) tra lai username cua user
...
router.put('/:id', verifyToken, async(req, res) => {
    ...
    try {
       ...
       const postUpdateCondition = {id: req.params.id, user: req.userId}
